                ...
                <div className="flex justify-center items-center space-x-10">
                    ...
                    <div className="flex p-3 space-x-2 border-2 border-white rounded-md items-start">
                        ...
                        <div className="space-y-3">
                            <p className="italic font-semibold text-white text-lg">First-Time Buyers Guide</p>
                            <p className="text-white">Helping you navigate the process of buying your first home</p>
                            <p className="px-1 bg-gray-400 text-white w-fit rounded-md">Guide</p>

                            <div className="flex items-center space-x-1">
                                <img className="rounded-full" src="https://picsum.photos/20/20" alt="img" />

                                <p className="text-white text-sm">Ucan Finance Team</p>
                            </div>
                        </div>
                    </div>
...
export default MoratageAssistance