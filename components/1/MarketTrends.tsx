...
function MarketTrends() {
  return (
    <>
    <div className="px-20 py-5 bg-blue-500 space-y-4">
        ...
        <div className="flex  justify-center space-x-5">
            ...
            <div className="p-2 w-full rounded-md border-2 border-white">
        ...
        <div className="space-y-3 ">
            ...
            <div className="border-2 rounded-md border-white w-full h-100">
