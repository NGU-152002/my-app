        ...
        <div className="bg-cover w-full h-[500px]" style={{ backgroundImage: "url('https://picsum.photos/1336/768')" }}>
            <div className="p-7 space-y-3">
                <div>
                    ...
                    <p className="text-4xl font-bold text-blue-500" >FIND YOUR</p>
                    <p className="text-6xl font-bold text-amber-500">DREAM <span className="text-blue-600">HOME</span></p>
                </div>
                <p className="text-4xl font-bold text-blue-500">WITH US</p>
            ...
            <div className="relative  w-full h-5xl max-w-5xl mx-auto py-12">
                ...
                <div className="flex  justify-center space-x-4  px-4">
                    ...
                    <div className="relative rounded-lg p-6 bg-white shadow-lg w-64 space-y-7">
                        <div className="w-20 h-20 absolute -top-10 left-1/2 transform -translate-x-1/2 rounded-full flex justify-center items-center bg-amber-400">
                            <img className="rounded-full" src="https://picsum.photos/60/60" alt="Market analysis" />
                        </div>
                        <p className="text-2xl pt-10 font-semibold text-center text-blue-600">Market Analysis</p>
                    ...
                    <div className="relative rounded-lg p-6 bg-white shadow-lg w-64 space-y-7">
                        ...
                        <p className="text-2xl pt-10 font-semibold text-center text-blue-600">Investment Strategy</p>
                        <p className="text-gray-600 text-center">
                    ...
                    <div className="relative rounded-lg p-6 bg-white shadow-lg w-64 space-y-7">
                        ...
                        <p className="text-2xl pt-10 font-semibold text-center text-blue-600">Risk Management</p>
                        <p className="text-gray-600 text-center">
                    ...
                    <div className="relative rounded-lg p-6 bg-white shadow-lg w-64 space-y-7">
                        ...
                        <p className="text-2xl pt-10 font-semibold text-center text-blue-600">Portfolio Review</p>
                        <p className="text-gray-600 text-center">
