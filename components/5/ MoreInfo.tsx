        ...
        <div className="px-30">
            ...
            <div  className="  space-y-5">
                ...
                <div className="flex items-center space-x-3">
                    <img className="h-fit w-fit object-cover" src="https://picsum.photos/50/50" alt="img" />
            ...
            <img className="object-cover shadow-xl" src="https://picsum.photos/400/400" alt="img" />

            
            </div>

            <div className="min-w-full min-h-150 bg-gray-300">
                <p className="w-full min-h-150 flex justify-center items-center text-3xl font-bold">Map Info Here</p>
