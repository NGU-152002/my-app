...
function LocateLocalAgentBanner() {
    ...
    //                 <button className='px-3 py-2 font-semibold  rounded-lg bg-amber-400'>Find your location agent</button>
    //             </div>
    //             <div className='relative w-70 h-70'>
    //     {/* Visible part of the circle (top half) */}
    //     <div className='absolute bottom-0 w-full h-20 overflow-hidden'>
    //       <div className='absolute -top-20 w-full h-100  bg-amber-400' />
    //     </div>
...
<div className="flex  items-center justify-between bg-[#0C2D65] text-white rounded-lg p-8 py-3 relative overflow-hidden">
  <div className="max-w-md space-y-4 z-10">
    ...
    <button className="flex items-center gap-2 bg-yellow-400 text-black px-6 py-3 rounded-full font-semibold shadow-md hover:bg-yellow-300 transition">
  ...
  <div className="relative w-[400px] h-[400px] z-10 flex items-end justify-center">
    ...
    <div className="absolute -bottom-5 w-full h-1/2 bg-yellow-400 rounded-t-full z-0"></div>
    </div>
    <img src="https://picsum.photos/260/260" alt="Agent" className="absolute top-1 z-10 w-[260px] object-cover" />
  </div>
</div>
