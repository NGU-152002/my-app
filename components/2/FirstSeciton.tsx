...
function FirstSeciton() {
  ...
  return ( 
    ...
    <div className={`transition-all duration-300 ${show ? 'w-1/2' : 'w-full'}`}>
              ...
              <div className={`px-3 transition-all duration-300 ${show ? 'translate-x-0' : 'translate-x-1/2'}`}>
                  <p className='text-white font-bold text-2xl'>
                      Redefining Real Estate, <br /> One Community at a Time
                  </p>
                  <p className="text-white">At U Can Realty,we're not just property experts - we're community builders</p>
              </div>
          </div>
    ...
    <div className={`transition-all duration-300 ${show ? 'w-1/2' : 'w-0 overflow-hidden'}`}>
        <img className="w-full object-cover h-[150px]" src="https://picsum.photos/400/400" alt="img" />
        <div>
            <p className='text-white font-bold text-2xl'>Redefining Real Estate, <br/> One Community at a Time</p>
        </div>
    </div>
</div>
